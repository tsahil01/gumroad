    ...
    <>
      ...
      <div className="squished fixed-aside flex-1 lg:grid lg:grid-cols-[1fr_30vw]">
        ...
        <CheckoutPreview cartItem={previewCartItem}>
          <dialog
            className="fixed top-1/2 left-1/2 z-20 flex w-fit max-w-[43.75rem] min-w-80 -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded border border-border bg-background p-8 text-foreground shadow-md backdrop:bg-black/80 dark:shadow-none [&:not([open])]:hidden"
            open
